    ...
    return (
      <div className="teamPage">
        <div className="tp-header">
          ...
          <p>
            Our team wants to provide a refreshing experience to the users while
            exploring city trees across Vancouver. Our website will take users
            through a virtual walk around the city and provide comprehensive
            information about tree population, tree variants, and leaf
            illustrations.
          </p>
          <p>
            Our team consists of seven dedicated members who have expertise in
            design, visual graphics, content creation and software development.
            With the help of an extremely strong and innovative team, Treespree
            is catering to the personalized experience for users.
          </p>
          <p>
            Our team members are nature lovers and this has cultivated a strong
            passion for sharing enriching information with our community through
            TreeSpree. Our team’s vision is to partner with urban planners in
            order to develop plans and programs for the use of land in a
            sustainable way.
          </p>
        </div>
