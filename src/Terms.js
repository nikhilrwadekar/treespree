    ...
    return (
      <div className="Terms">
        ...
        <p>
          ...
          conditions. Do not continue to use Treespree if you do not agree to
        ...
        <p>
          ...
          use cookies in agreement with the Treespree's Privacy Policy.
        </p>
        ...
        <p>
          ...
          intellectual property rights for all material on Treespree. All
          intellectual property rights are reserved. You may access this from
          Treespree for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Treespree</li>
          <li>Sell, rent or sub-license material from Treespree</li>
          <li>Reproduce, duplicate or copy material from Treespree</li>
          <li>Redistribute content from Treespree</li>
        </ul>
        ...
        <p>
          ...
          Treespree does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Treespree,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Treespree shall
        ...
        <p>
          Treespree reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Treespree a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Treespree; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Treespree. Please include your name, your
        ...
        <p>
          No use of Treespree's logo or other artwork will be allowed for
